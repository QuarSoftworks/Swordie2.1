    ...
    metrics.init({ apiKey: this.client.config.datadogApiKey, host: 'pogy', prefix: 'pogy.' });
      ...
      if (message.content.match(mentionRegex)) {
        ...
        const embed = new MessageEmbed()
          .setTitle(`Hello, I\'m ${jsconfig.bot_name}. What\'s Up?`)
          .addField(`Prefix`,proofita, true)
          .addField(`Usage`,proofitaa, true)
          .setDescription(`\nIf you like ${jsconfig.bot_name}, Consider [inviting](https://discord.com/oauth2/authorize?client_id=${jsconfig.client_id}&scope=bot&permissions=470150262) it to your server! Thank you for using ${jsconfig.bot_name}, we hope you enjoy it, as we always look forward to improve the bot`)
          .setFooter(`Thank you for using ${jsconfig.bot_name}!!`)
          .setColor('#FF2C98')
...
message.channel.send(`${jsconfig.bot_name} is currently undergoing maintenance which won't allow anyone to access ${jsconfig.bot_name}'s Commands. Feel free to try again later. For updates: https://discord.gg/vHwvZufVbt`)
