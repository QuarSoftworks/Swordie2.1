...
logger.info(`✅ loaded Maintenance Mode `, { label: 'Status' })
    ...
    setInterval(() => {
      activities[2] = { name: `s!help | ${ this.client.guilds.cache.size} guilds`, type: 'WATCHING' };
      activities[3] = { name: `s!help | ${ this.client.guilds.cache.reduce((a, g) => a + g.memberCount, 0)} users`, type: 'WATCHING' }; 
