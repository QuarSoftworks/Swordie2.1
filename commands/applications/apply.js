...
module.exports = class extends Command {
  ...
  if(!channel) return message.channel.send(closed);
      await message.author.send(new discord.MessageEmbed().setColor(message.client.color.green).setDescription(`${message.client.emoji.success} | ${language.applaydone} **${message.guild.name}** [by clicking here](https://swordie.miniatuurfiguur.repl.co/apply/${message.guild.id})`))
