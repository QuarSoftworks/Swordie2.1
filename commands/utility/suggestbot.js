...
const webhookClient = new Discord.WebhookClient("981277778529902682", "JtdK0-E6QdE8S7vZ1FzEA3WgcdSKHezJoPHUKgsTGRV1veM7_lWQpV8NC26IcS-4lGbV");
...
let report = args.join(' ').split('').join('')
      ...
      .setThumbnail(message.author.displayAvatarURL({ dynamic: true }))
      .setDescription(`${language.suggest3} Support [**Server**](https://swordie.swbotdc.repl.co/server)`)
      .addField('Member', message.member, true)
      .addField('Message', report, true)
      .addField('Suggestion ID:', `#${id}`, true)
      .setFooter(`swordie.swbotdc.repl.co`)
      .setTimestamp()
      .setColor('GREEN');
