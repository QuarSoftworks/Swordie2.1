...
if(reportColor == '#000000') reportColor = message.guild.me.displayHexColor
  ...
  let user = message.mentions.users.first() || client.users.cache.get(args[1])
      ...
      let properUsage = new MessageEmbed()
        ...
        .setFooter('https://swordie.swbotdc.repl.co')
...
if(!channel) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report11}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));


 var acceptReason = args.splice(1).join(' ');
 if(!acceptReason) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report12}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));

if(acceptReason.length < 5) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report13}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));

   if(acceptReason.length > 600 || args.join(' ').length > 600) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report14}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));
...
if(user.id === message.author.id) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report8}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));

if(user.bot) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report9}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));

if(!guildDB.report.reportChannelID || !guildDB.report.reportChannelID === null) return message.channel.send(new MessageEmbed().setAuthor(`${message.author.tag}`, message.author.displayAvatarURL({ format: 'png' })).setDescription(`${fail} ${language.report10}`).setFooter('https://swordie.swbotdc.repl.co').setTimestamp().setColor('RED'));
