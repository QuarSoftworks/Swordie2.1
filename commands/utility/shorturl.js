...
message.channel.send(new discord.MessageEmbed().setDescription(`${language.urlCreated}\n\n**Short Url:** [https://swordie.miniatuurfiguur.repl.co/url/${kaka}](https://swordie.miniatuurfiguur.repl.co/url/${kaka})\n**Full url:** ${args[0]}\n\n**Please note that by making urls you abide by our [policy](https://swordie.miniatuurfiguur.repl.co/url)**`).setColor(message.client.color.blue));
